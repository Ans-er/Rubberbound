...
namespace Obi
{
    public abstract class ObiRopeBlueprintBase : ObiActorBlueprint
    {
        ...
        // LOCAL MODIFICATION: upper bound raised from 1 to 4 so the rope can use overlapping
        // (denser-than-touching) particles and stay gap-free even at high stretch. NOTE: this
        // edits a vendor file and WILL be overwritten when Obi is updated. Prefer enabling the
        // rope actor's Surface Collisions instead — it closes the same gaps far more cheaply.
        [Range(0, 4)]
